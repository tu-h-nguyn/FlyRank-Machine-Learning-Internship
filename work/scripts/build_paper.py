...
from configure_site import analytics_block, read_analytics  # noqa: E402
...
ANALYTICS_PROVIDER, ANALYTICS_ID = read_analytics(
    SITE.get("analytics_id", "") or SITE.get("goatcounter_code", ""))
...
# function configure_site.py stamps into the served pages, so rebuilding the paper
# cannot silently reinstate an analytics snippet the config has moved off.
